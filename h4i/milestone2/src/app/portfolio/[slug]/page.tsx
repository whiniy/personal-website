    ...
    if (slugProject == null) {
        ...
        return (
            <div className={style.container}>
                ...
                <Image width={0} height={0} sizes="100vw" style={{ width: '50%', height: 'auto' }} className= {style.homePic} src= {slugProject.image} alt={slugProject.alt}></Image>
                <br></br>
                <br></br>
                <p className={style.content}>{slugProject.content}</p>
                <Link className = {style.a} href={slugProject.link} target="_blank" rel="noopener noreferrer">VISIT PROJECT!</Link>
            </div>
        )
    }
}